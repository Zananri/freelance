    ...
    <div class="row" style="height: calc(100vh - 150px); ">
        ...
        <div class="col-md-8 d-flex flex-column">
            ...
            <div class="row flex-grow-1" style="flex: 1;">
                ...
                <div class="col-md-6 mb-3">
                    <div class="rounded-4 p-4 px-5 body-content h-100">
                        ...
                        <div class="attendance-actions mt-2 w-100 d-flex justify-content-evenly">
                            <button class="btn btn-check-in w-25 m-2 p-2 fw-normal" id="checkInBtn">Check In</button>
                            <button class="btn btn-check-out w-25 m-2 p-2 fw-normal" id="checkOutBtn">Check Out</button>
                        </div>
                ...
                {{-- Calendar --}}
                <div class="col-md-6 mb-3">
                    <div class="rounded-4 p-4 px-5 body-content calendar-container h-100">
        ...
        {{-- KANAN: Task --}}
        <div class="col-md-4">
            <div class="rounded-4 p-4 body-content h-100 d-flex flex-column">
                ...
                <div class="btn-group w-100 mb-3">
                    <button class="btn btn-light flex-fill active">Today</button>
                    ...
                    <div class="task-card p-3 mb-3 rounded" style="background-color: #FFFAE6;">
                        ...
                        <div class="d-flex justify-content-between align-items-center small mt-3"
                            ...
                            <div>
                                ...
                                <span class="text-secondary">Deadline:</span><span class="mx-2">17 Aug 2025</span>
                            </div>
                            <div class="d-flex">
