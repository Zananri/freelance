            ...
            <div class="body-content rounded-4 p-3">
                <div class="d-flex align-items-center">
                    @php
                        ...
                        $imgUrl = $img ? asset('file/project/' . ltrim($img, '/')) : asset('asset/img/project-placeholder.png');
                    @endphp
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex">
                        <a href="{{ route('project.edit', ['id' => $project->id]) }}" class="detail-icon" title="Edit">
                            <span class="material-symbols-outlined icon-fill me-3">edit</span>
                        </a>
                        <form action="{{ route('project.destroy', ['id' => $project->id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this project?');">
                            @csrf
                            @method('DELETE')
                ...
                <div class="d-flex justify-content-between detail-list">
                    <p>Deadline</p>
                    <p>{{ $project->due_date ? \Carbon\Carbon::parse($project->due_date)->format('d M Y') : '-' }}</p>
                </div>
                <div class="d-flex justify-content-between detail-list">
                    <p>Department</p>
