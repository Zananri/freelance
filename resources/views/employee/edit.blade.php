                ...
                <div class="col-md-4 d-flex flex-column gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" id="employee_name" name="employee_name" class="form-control"
                            placeholder="Input Employee Name" value="{{ $employee->name }}" required />
                        <div class="invalid-feedback">
                    ...
                    <div>
                        ...
                        <input type="email" id="employee_email" name="employee_email" class="form-control"
                            placeholder="Input Employee Email" value="{{ $employee->email }}" required />
                        <div class="invalid-feedback">
                    ...
                    <div>
                        ...
                        <input type="number" id="employee_phone" name="employee_phone" class="form-control"
                            placeholder="Input Employee Phone" value="{{ $employee->phone }}" required />
                        <div class="invalid-feedback">
                ...
                <div class="col-md-3 d-flex flex-column gap-3">
                    <div>
                        ...
                        <input type="text" id="address" name="address" class="form-control"
                            placeholder="Input Employee Address" value="{{ $employee->address }}" required />
                        <div class="invalid-feedback">
                        ...
                        <div class="flex-fill">
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn-submit-black btn-submit-custom"
                                    style="font-size: 14px;">Update Employee</button>
                            </div>
                        </div>
                        <div class="flex-fill">
