        ...
        <form id="employeeEditForm" class="needs-validation" enctype="multipart/form-data" novalidate action="{{ url('employees/' . $employee->id) }}" method="POST">
            ...
            <div class="px-3 py-3" style="">
                <div class="row">
                    ...
                    <div class="col-md-4 d-flex flex-column gap-3">
                        <div>
                            ...
                            <input type="text" id="employee_name" name="employee_name" class="form-control" value="{{ $employee->name }}" required />
                        ...
                        <div>
                            ...
                            <input type="email" id="employee_email" name="employee_email" class="form-control" value="{{ $employee->email }}" required />
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-4 d-flex flex-column gap-3">
                        <div>
                            ...
                            <select id="department_id" name="department_id" class="form-select" required data-current="{{ $employee->department_id }}">
                        ...
                        <div>
                            ...
                            <select id="division_id" name="division_id" class="form-select" required data-current="{{ $employee->division_id }}">
                        ...
                        <div>
                            ...
                            <select id="job_id" name="job_id" class="form-select" required data-current="{{ $employee->job_id }}">
                        ...
                        <div>
                            ...
                            <select id="office" name="office" class="form-select" required>
                                ...
                                <option value="NSA Performance" {{ $employee->office == 'NSA Performance' ? 'selected' : '' }}>NSA Performance</option>
                                <option value="Gudang SEHA" {{ $employee->office == 'Gudang SEHA' ? 'selected' : '' }}>Gudang SEHA</option>
                            </select>
                            <div class="invalid-feedback">
                        ...
                        @if ($employee->profile_picture)
                            <small class="text-muted">Current file: {{ basename($employee->profile_picture) }}</small>
                        @endif
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <label for="photo" class="custom-image-upload-photo position-relative photo-upload {{ $employee->photo ? 'has-image' : '' }}"
                                style="background-image: url('{{ $employee->photo ? asset($employee->photo) : '' }}'); opacity: {{ $employee->photo ? '1' : '0.5' }};">
                                <input type="file" id="photo" name="photo" accept="image/*"
                                    class="photo-input" hidden />
                                <div class="invalid-feedback" style="position: absolute; bottom: -20px; left: 0;">
                                    Please upload a photo.
                                </div>
                                <span class="image-clear-btn {{ $employee->photo ? '' : 'd-none' }}" id="photoClearBtn"
                        ...
                        <div>
                            ...
                            <label for="ktp" class="custom-image-upload-ktp position-relative ktp-upload {{ $employee->ktp ? 'has-image' : '' }}"
                ...
                <div class="text-center px-2 py-3">
                    <button type="submit" class="btn-submit-black btn-submit-custom" style="font-size: 14px;">Update Employee</button>
                </div>
            </form>
        </div>
