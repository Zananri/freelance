                ...
                <form id="checkInForm">
                    ...
                    <div class="mb-3" id="imageUploadSection">
                        ...
                        <div class="image-upload-container">
                            ...
                            <!-- Video kamera -->
                            <video id="cameraVideo" autoplay playsinline class="w-100 rounded mt-2" style="max-height: 400px; display:none;"></video>
                            <canvas id="cameraCanvas" class="d-none"></canvas>

                            <!-- Capture button -->
                            <button type="button" class="btn btn-primary mt-2 d-none" id="captureBtn">
                            ...
                            <!-- Clear button -->
                            <button type="button" class="image-clear-btn d-none" id="clearImageBtn" style="display:none;">&times;</button>
                        </div>
                    </div>
                </form>
            </div>
