<x-office-layout>
            ...
            <div class="modal-content modal-content-custom">
                ...
                <form id="addTaskForm" enctype="multipart/form-data">
                    <div class="modal-body modal-body-custom">
                        <div id="addTaskAlert" class="alert alert-success d-none" role="alert" style="margin-bottom: 1rem; display:none;">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="task_image" class="custom-image-upload position-relative" id="taskImageLabel"
                                ...
                                <input type="file" class="input-image" id="task_image" name="image" accept="image/*"
                                hidden>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control input-text" id="task_description" name="description" rows="3"></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control input-text" id="task_point" name="point" value="1" min="1" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 d-flex justify-content-between">
                            <div style="width: 48%;">
                                ...
                                <input type="date" class="form-control input-text" id="task_start_date" name="start_date"
                                    required>
                            </div>
                            <div style="width: 48%;">
                                <label for="task_due_date" class="form-label label-custom">Due Date</label>
                                <input type="date" class="form-control input-text" id="task_due_date" name="due_date"
                                    required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="task_complete_date" class="form-label label-custom">Complete Date</label>
                            <input type="date" class="form-control input-text" id="task_complete_date" name="complete_date">
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editProjectModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="editProjectModalLabel" aria-hidden="true" data-employee-id="{{ auth()->user()->employee->id ?? '' }}">
        <div class="modal-dialog">
            <div class="modal-content modal-content-custom">
    ...
    <div class="modal-body modal-body-custom">
        ...
        <div class="mb-3 d-flex justify-content-between">
            <div style="width: 48%;">
                ...
                <input type="date" class="form-control input-text" id="edit_start_date" name="start_date"
                    required>
            </div>
            <div style="width: 48%;">
                <label for="edit_due_date" class="form-label label-custom">Due Date</label>
                <input type="date" class="form-control input-text" id="edit_due_date" name="due_date"
                    required>
            </div>
        </div>
        <div class="mb-3">
            <label for="edit_part_of_project" class="form-label label-custom">Part of Project</label>
            <select class="form-select input-select" id="edit_part_of_project" name="part_of_project">
                <option value="">Select Project</option>
                <!-- Options to be populated dynamically -->
            </select>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 400px;">
            <div class="modal-content modal-content-custom">
                ...
                <div class="modal-body modal-body-custom d-flex flex-column align-items-center">
                    <img id="deleteProjectImage" src="" alt="Project Image" style="width: 150px; height: 150px; object-fit: cover; border-radius: 8px; margin-bottom: 1rem;">
