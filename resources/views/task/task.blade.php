<x-office-layout>
    ...
    <div class="modal fade" id="addScheduleModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-content-custom">
                <div class="modal-loading-overlay d-none" id="addScheduleModalLoader">
                    <div class="loader-spinner"></div>
                </div>
                <div class="modal-header modal-header-custom">
                    <h5 class="modal-title modal-title-custom" id="addScheduleModalLabel">Add Schedule</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="addScheduleForm" enctype="multipart/form-data">
                    <div class="modal-body modal-body-custom">
                        <div id="addScheduleAlert" class="alert alert-success d-none" role="alert" style="display:none;">
                            Schedule saved!
                        </div>

                        <!-- Recurrence Top Controls -->
                        <div class="mb-3 d-flex justify-content-between">
                            <div class="date-form">
                                <label for="schedule_recurrence_start_date" class="form-label label-custom">Start From</label>
                                <input type="date" class="form-control input-text" id="schedule_recurrence_start_date" name="recurrence_start_date" required>
                            </div>
                            <div class="date-form">
                                <label for="schedule_recurrence_end_date" class="form-label label-custom">End At (optional)</label>
                                <input type="date" class="form-control input-text" id="schedule_recurrence_end_date" name="recurrence_end_date">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex flex-column gap-2">
                                <select class="form-select input-select" id="schedule_recurrence_type" name="recurrence_type" required>
                                    <option value="" selected>Select Option Schedule</option>
                                    <option value="daily">Every Day</option>
                                    <option value="weekly">Every Week</option>
                                    <option value="monthly">Every Month</option>
                                </select>
                                <div id="schedule_weekly_opts" class="d-none d-flex align-items-center gap-2">
                                    <span>on</span>
                                    <select class="form-select input-select" id="schedule_recurrence_day_of_week" name="recurrence_day_of_week" style="max-width: 200px;">
                        ...
                        <!-- Same as Add Task inputs -->
                        <div class="mb-3">
                            <div class="title-label-image">
                                <span>Upload image</span>
                            </div>
                            <label for="schedule_image" class="custom-image-upload position-relative" id="scheduleImageLabel"
                                style="background-image: url('{!! asset('asset/img/background/add-image.png') !!}');">
                                <input type="file" class="input-image" id="schedule_image" name="image" accept="image/*" hidden>
                                <span class="image-clear-btn d-none" id="scheduleImageClearBtn" title="Remove image">&times;</span>
                            </label>
                        </div>
                        <div class="mb-3">
                            <label for="schedule_title" class="form-label label-custom">Title</label>
                            <input type="text" class="form-control input-text" id="schedule_title" name="title" required>
                        </div>
                        <div class="mb-3">
                            <label for="schedule_description" class="form-label label-custom">Description</label>
                            <textarea class="form-control input-text" id="schedule_description" name="description" rows="6"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="schedule_project_id" class="form-label label-custom">Project (optional)</label>
                            <select class="form-select input-select" id="schedule_project_id" name="project_id">
                                <option value="">No Project</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="schedule_point" class="form-label label-custom">Point</label>
                            <input type="number" class="form-control input-text" id="schedule_point" name="point" value="1" min="1" required>
                        </div>
                        <div class="mb-3">
                            <label for="schedule_priority" class="form-label label-custom">Priority</label>
                            <select class="form-select input-select" id="schedule_priority" name="priority" required>
                                <option value="">Select Priority</option>
                                <option value="HIGH">HIGH</option>
                                <option value="MEDIUM">MEDIUM</option>
                                <option value="LOW">LOW</option>
                        ...
                        <div class="mb-3">
                            <label for="schedule_reference_files" class="form-label label-custom">Reference Files</label>
                            <input type="file" class="form-control input-text" id="schedule_reference_files" name="reference_files[]" accept="image/*,.pdf,.doc,.docx,.xls,.xlsx,.zip" multiple>
                            <div class="form-text">Multiple files supported.</div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control input-text" id="schedule_executor_input" name="schedule_executor_input" autocomplete="off" placeholder="Search employees...">
